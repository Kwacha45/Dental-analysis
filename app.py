...
app = dash.Dash(__name__, title="Cruz Dentals", external_stylesheets=[dbc.themes.SPACELAB],
...
app.layout = dbc.Container([
    dbc.Row([
        html.P("Welcome to Cruz, an AI powered Dental Diagnosis and Treatment Tool",
...
def control_recording(n_clicks, drp, drp1, drp2, drp3, drp4, drp5):
    if n_clicks:
        ...
        # newDf = {"Tooth Damage": "", "Gum Issues": "", "Oral Infections Abnormalities": "",
        #          "Tooth Eruption Alignment": "", "Jaws Issues TeethGrinding": "",
